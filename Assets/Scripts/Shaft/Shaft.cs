...
public class Shaft : MonoBehaviour
{
    ...
    [SerializeField] private ShaftData shaftData;
    ...
    public ShaftData ShaftData => shaftData;
    ...
    public void Initiliaze(ShaftData shaftData)
    {
    ...
    public void CreateMiner()
    {
        ...
        newMiner.Initiliaze(shaftData.MinerData);
