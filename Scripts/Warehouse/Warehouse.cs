...
{
    [Header("Prefab")]
    [SerializeField] private GameObject warhouseMinerPrefab;
    ...
    {
        GameObject newMiner = Instantiate(warhouseMinerPrefab, warehouseDepositLocation.position, Quaternion.identity);
        ...
        miner.WarhouseLocation = warehouseDepositLocation;
        miners.Add(miner);
    }
